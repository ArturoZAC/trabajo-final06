...
test("GET -> BASE_URL, should return StatusCode200, and res.body.length === 1", async()=>{
    const res = await request(app)
        .get(BASE_URL)
...
test("POST -> BASE_URL, should return StatudCode 201, and res.body.firstName === user.firstName", async()=>{
    const user = {
        firstName: "Maicol",
        lastName: "Salazar",
